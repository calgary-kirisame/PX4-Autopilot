...
// Default minimum interval (ms) between uORB updates forwarded to DDS
// (/fmu/out/*) -- 10 ms = 100 Hz cap. Override per topic with `rate_limit: <hz>`
// in dds_topics.yaml (backport of TheLukaDragar/PX4-Autopilot 238dffcd1b).
